...
class LeapFrog():
    ...
    def __init__(self,problem=1):
        ...
        types = get_types()
        function_name = 'leap_frog'
        file_name = 'leap_frog.so'
        ...
        self.leapfrog_class = f90_compiler(function_name, file_name, arg_types)
    ...
    def calculate_uk_LF(self,k):
        ...
        u_out = self.leapfrog_class.leap_frog_func(u_out,dt,dx,self.gamma,Nt,Nx,self.f_source,u_0)
    ...
    def p_convergence(self,k):
        ujk,xk,t = self.calculate_uk_LF(k)
        uj0,x0,t2 = self.calculate_uk_LF(0)
...
def plot_p1(k):
    nm = LeapFrog(problem=1)

    u_out,x,t = nm.calculate_uk_LF(k)
